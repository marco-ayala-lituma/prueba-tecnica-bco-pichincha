...
CREATE TABLE Cuenta (
    ...
    SaldoInicial DECIMAL(18, 2) NOT NULL DEFAULT (0), -- Saldo inicial de la cuenta
...
CREATE TABLE Movimiento (
    ...
    Valor DECIMAL(18, 2) NOT NULL DEFAULT(0), -- Valor del movimiento
    Saldo DECIMAL(18, 2) NOT NULL DEFAULT(0), -- Saldo después del movimiento
